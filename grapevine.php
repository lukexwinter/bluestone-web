        ...
        <div id="content" class="work-detail grapevine">
        	<div class="project-head"><img src="img/grapevine-logo.png" /></div>
			<div class="project-body">
				<div class="title clearfix">
					<h2>Grapevine Station</h2> 
				...
				<div class="work full">
					...
					<div class="full-width-slider royalSlider heroSlider rsMinW rsHor rsWithBullets">
					    ...
					    <!-- lazy loaded image slide -->
					    <a class="rsImg" href="<?php echo MAINURL."/img/"; ?>grapevine-brand-slide-2.jpg"></a>
					    <!-- lazy loaded image slide -->
					    <a class="rsImg" href="<?php echo MAINURL."/img/"; ?>grapevine-brand-slide-3.jpg"></a>
					</div>
				</div>
				...
				<div class="clearfix">
					...
					<div class="work half">
						<img class="lazy" data-original="<?php echo MAINURL.""; ?>/img/grapevine-brand-half-1.jpg" alt="" width="708" height="447" />
					</div>
				</div>
					
				<div class="work three-quarters">
					<span class="caption">Print &amp; Packaging<span class="grid-marker"></span></span>
					<img class="lazy" data-original="<?php echo MAINURL.""; ?>/img/grapevine-brand-three-quarters-1.jpg" alt="" />
				</div>
				...
				<div class="clearfix">
					...
					<div class="work half">
						<img class="lazy" data-original="<?php echo MAINURL.""; ?>/img/grapevine-print-half-1.jpg" alt="" />
					</div>
				</div>	
				...
				<div class="work full">
					<div class="full-width-slider royalSlider heroSlider rsMinW rsHor rsWithBullets">
					    <!-- lazy loaded image slide -->
					    <a class="rsImg" href="<?php echo MAINURL."/img/"; ?>grapevine-print-slide-1.jpg"></a>
					    <!-- lazy loaded image slide -->
					    <a class="rsImg" href="<?php echo MAINURL."/img/"; ?>grapevine-print-slide-1.jpg"></a>
					</div>
				</div>
				...
				<div class="work full">
					...
					<div class="web full-width-slider royalSlider heroSlider rsMinW rsHor rsWithBullets">
					    <!-- lazy loaded image slide -->
					    <a class="rsImg" href="<?php echo MAINURL."/img/"; ?>grapevine-web-slide-1.jpg"></a>
					    <!-- lazy loaded image slide -->
					    <a class="rsImg" href="<?php echo MAINURL."/img/"; ?>grapevine-web-slide-1.jpg"></a>
					</div>
				</div>
				...
				<div class="clearfix">
					...
					<div class="work half">
						<img class="lazy" data-original="<?php echo MAINURL.""; ?>/img/grapevine-web-half-1.jpg" alt="" />
						<img class="lazy" data-original="<?php echo MAINURL.""; ?>/img/grapevine-web-half-2.jpg" alt="" />
					</div>
				</div>
